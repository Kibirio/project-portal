        ...
        @if(session('status'))
            ...
            <div class="row mt-1">
                <div class="offset-2 col-md-10">
                    <span>
                        <h2 class="text-capitalize font-weight-bold">SCI HUB PORTAL - Student Registration</h2>
                    </span>
                </div>
            </div>
            ...
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="regno" id="regno" placeholder="Admission Number" class="bg-gray-100 border-2 w-full p-2 rounded-lg @error('regno') border-red-500 @enderror" value="{{ old('regno') }}">
